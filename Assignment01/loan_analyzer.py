...
# YOUR CODE HERE!
average_loan = total_loans/num_of_loans
print(average_loan)
...
if present_value >= loan["loan_price"]:
    ...
    print("NOT TO BUY, TOO EXPENSIVE")
...
for loan in loans:
    if loan["loan_price"]<=500:
        inexpensive_loans.append(loan.values())
...
output_path = Path("Assignment01/inexpensive_loans.csv")
